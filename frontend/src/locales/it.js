import { lidcWhiteboardItemsIt } from '../config/lidcStorylineWhiteboardCopy';
...
export default {
  general: {
    ...
    auth: {
      ...
      close: 'Chiudi',
      privacyBeforeLogin: 'Accedendo, Discord ci comunica il tuo profilo pubblico (identificativo, nome e avatar). Dettagli:',
  ...
  lidc: {
    ...
    map: {
      ...
      airportWizard: {
        ...
        orderCode: 'Codice',
        copyOrderCode: 'Copia codice ordine',
        container: 'Container',
        smallContainer: 'Small Container',
        crate: 'Cassa',
        searchCargo: 'Cerca cargo…',
        clearSearch: 'Cancella ricerca',
        searchEmpty: 'Nessun cargo corrisponde alla ricerca.',
        ...
        spawn: {
          login: 'Accedi per spawnare unità e casse.',
          infantry: 'Fanteria da imbarcare',
          buildCrates: 'Casse per costruzioni',
          deployables: 'Casse per veicoli deployabili',
          dbuildBundles: 'Bundle DBUILD',
          kindInfantry: 'Fanteria',
          kindCrate: 'Cassa',
          kindBundle: 'Bundle',
          MANPAD: 'Squadra Stinger',
          SCOUT: 'Fanteria da ricognizione',
          ASSAULTER: 'Fanteria d\'assalto',
    ...
    storyline: {
      ...
      dossier: {
        ...
        photoCaption: 'FOTOGRAFIA DEL SOGGETTO',
        copy: 'COPIA 1 DI 3',
        control: 'DOCUMENTO CONTROLLATO — NON RIMUOVERE DALLA SCIF',
        handle: 'HANDLE VIA COMINT CHANNELS ONLY',
        originated: 'ORIGINATO: KANDAHAR / LIDC',
        fileNo: 'FILE NO.',
        subject: 'SOGGETTO',
      },
      ...
      whiteboardItems: lidcWhiteboardItemsIt,
      ...
      debug: {
        ...
        pinLayoutResetAction: 'Reset pin',
        pinLayoutCopied: 'Layout pin copiato.',
        pinLayoutReset: 'Layout pin ripristinato.',
        targets: {
          room: 'Stanza',
          whiteboard: 'Lavagna',
        },
