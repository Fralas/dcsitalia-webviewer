  ...
  lidc: {
    ...
    storyline: {
      ...
      debug: {
        ...
        hint: 'Seleziona Stanza o Lavagna, trascina il gizmo o modifica i valori. Tasti: L pannello, T cambia target, G muovi, R ruota, E scala, Esc chiude. Incolla il JSON in frontend/src/config/lidcStorylineRoomTransform.json per fissarlo nel repo.',
      },
    },
    debug: {
