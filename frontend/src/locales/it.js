  ...
  lidc: {
    ...
    storyline: {
      ...
      debug: {
        ...
        zoneLabel: 'Etichetta',
        zoneEventId: 'Event ID (es. whiteboard)',
        ...
        hint: 'Seleziona Stanza/Lavagna o una zona dalla lista. Verde = trigger evento, arancio = collisione. Salva il JSON per fissare nel repo.',
      },
    },
    debug: {
