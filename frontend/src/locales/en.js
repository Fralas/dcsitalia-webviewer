  ...
  lidc: {
    ...
    storyline: {
      ...
      debug: {
        ...
        hint: 'Select Room or Whiteboard, drag the gizmo or edit values. Keys: L panel, T switch target, G move, R rotate, E scale, Esc close. Paste JSON into frontend/src/config/lidcStorylineRoomTransform.json to ship it.',
      },
    },
    debug: {
