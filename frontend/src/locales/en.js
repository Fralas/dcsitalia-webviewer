  ...
  lidc: {
    ...
    map: {
      ...
      airportWizard: {
        ...
        searchEmpty: 'No cargo matches this search.',
        ...
        spawn: {
          login: 'Sign in to spawn units and crates.',
          infantry: 'Infantry to embark',
          buildCrates: 'Crates for build assets',
          deployables: 'Crates for deployable vehicles',
          dbuildBundles: 'DBUILD bundles',
          kindInfantry: 'Infantry',
          kindCrate: 'Crate',
          kindBundle: 'Bundle',
          MANPAD: 'Stinger team',
          SCOUT: 'Recon infantry',
          ASSAULTER: 'Assault infantry',
    ...
    storyline: {
      ...
      debug: {
        ...
        pinLayoutResetAction: 'Reset pins',
        pinLayoutCopied: 'Pin layout copied.',
        pinLayoutReset: 'Pin layout restored.',
        targets: {
          room: 'Room',
