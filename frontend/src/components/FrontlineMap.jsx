    ...
    <section className="relative flex h-full min-h-0 w-full flex-col overflow-hidden">
            ...
            >
              ...
              {mapMode && filters.showDcsar && hoveredDcsarPoint && (
                <div className={`absolute bottom-4 z-[1000] w-[360px] rounded-xl border border-yt-border bg-[#1b1d2af0] p-3 shadow-2xl backdrop-blur ${filters.showAto && focusedZone ? 'left-[392px]' : 'left-4'}`}>
